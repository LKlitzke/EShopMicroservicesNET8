...
internal class InitialData
{
    ...
    new List<Customer>
    {
        ...
        Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "lucasK", "lucasK@gmail.com")
    };
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var address2 = Address.Of("lucas", "klitzke", "lucasK@gmail.com", "Martin Luther", "Brazil", "SundaysMartins", "08050");

            var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("lucasK", "8885555555554444", "06/30", "222", 2);
